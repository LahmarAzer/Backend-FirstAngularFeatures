...
public class productController {
    ...
    public void ajouterProduitFavori(@PathVariable Long idClient, @PathVariable Long idProduit) {
    ...
    public List<Product> getProduitsFavorisByClient(@PathVariable Long idClient) {
    ...
    public ResponseEntity<?> updateProduct(@RequestBody Product product, @PathVariable Long idUser, @PathVariable Long idProduct) {
        try {
    ...
    public ResponseEntity<?> addProduct(@RequestParam("idUser") Long idUser, @RequestParam("idCategory") Long idCategory,
    ...
    public void removeProduct(@PathVariable Long idProduct , @PathVariable Long idUser) {
