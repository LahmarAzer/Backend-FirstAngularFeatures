...
public class IProductServiceIMP implements IProductService {
    ...
    @Override
    public Product ajouterProduit(Product product,Long idUser,Long idCategory , Long idSousCategory , MultipartFile productImage) throws  IOException , ValidationException {
        User user = userRepository.findById(idUser).orElse(null);
